...
export default function HomePage() {
  return (
    <div className="px-4 py-8 sm:py-12 lg:py-16 max-w-7xl mx-auto">
      {/* Hero Section */}
      <section className="bg-gradient-to from-gray-700 to-gray-900 text-white rounded-lg mb-12 p-8 text-center">
        ...
        <Link
          href="/sign-up"
          className="inline-block bg-white text-gray-800 font-medium px-5 py-3 rounded hover:bg-gray-200 transition-colors"
        >
          Get Started
        </Link>
      </section>
      ...
      <section id="how-it-works" className="mb-12">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="flex flex-col items-center">
            <div className="bg-gray-700 text-white rounded-full h-16 w-16 flex items-center justify-center mb-4">
              {/* Icon for Step 1 */}
              <svg
