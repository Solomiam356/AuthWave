...
export default function MealPlanDashboard() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-100">
      <div className="w-full max-w-6xl flex flex-col md:flex-row bg-gray-200 shadow-lg rounded-lg overflow-hidden">
        {/* Left Panel: Form */}
        <div className="w-full md:w-1/3 lg:w-1/4 p-6 bg-gray-700 text-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 border border-gray-400 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-gray-500"
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-gray-400 border-gray-400 rounded"
              />
              <label htmlFor="snacks" className="ml-2 block text-sm text-gray-100">
                Include Snacks
              </label>
            </div>
            ...
            <div>
              <button
                ...
                className={`w-full bg-gray-600 text-gray-100 py-2 px-4 rounded-md hover:bg-gray-700 transition-colors ${
          ...
          {/* Error Message */}
          {mutation.isError && (
            <div className="mt-4 p-3 bg-gray-300 text-gray-800 rounded-md">
        ...
        <div className="w-full md:w-2/3 lg:w-3/4 p-6 bg-gray-100">
              ...
              <div className="space-y-6">
                {daysOfWeek.map((day) => {
                  ...
                  return (
                    <div
                      key={day}
                      className="bg-gray-200 shadow-md rounded-lg p-4 border border-gray-400"
                    >
